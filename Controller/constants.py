...
FORMATS = {DUMP_COMMAND:"B?IffffIII", DRIVE_COMMAND:"ii"}
...
DUMP_DATA_SENSOR_CALIB_1_CONST = 5
DUMP_DATA_SENSOR_CALIB_2_CONST = 6
DUMP_DATA_ANGULAR_VELOCITY_CONST = 7
DUMP_DATA_LINEAR_VELOCITY_CONST = 8
DUMP_DATA_FREQ = 9
